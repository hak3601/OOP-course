    ...
    while(1){
        ...
        if(user_command == 1){ // Take test exam
            ...
            */
            ...
            cout << "Select the course to take exam by entering the target_pos: ";
            getline(cin, course);
            // needed to ensure the user selecting the available course to take exam
            string n = "Data_structure";
            // exam = new TestExam(n);

            updateAvailableState(user, course, datafolder, "courses_available.csv");
